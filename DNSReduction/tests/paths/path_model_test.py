...
class DNSPathModelTest(unittest.TestCase):
    ...
    @patch('mantidqtinterfaces.DNSReduction.paths.path_model.DNSFile')
    @patch('mantidqtinterfaces.DNSReduction.paths.path_model.glob.iglob')
    ...
    @patch('mantidqtinterfaces.DNSReduction.paths.path_model.os.remove')
    @patch('mantidqtinterfaces.DNSReduction.paths.path_model.os.path.isfile')
