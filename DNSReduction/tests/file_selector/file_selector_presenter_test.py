...
from mantidqtinterfaces.DNSReduction.file_selector.file_selector_presenter \
    import DNSFileSelectorPresenter
from mantidqtinterfaces.DNSReduction.file_selector.file_selector_watcher \
    import DNSFileSelectorWatcher

from mantidqtinterfaces.DNSReduction.file_selector.file_selector_view \
    import DNSFileSelectorView
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing \
    import get_fileselector_param_dict
...
class DNSFileSelectorPresenterTest(unittest.TestCase):
    ...
    @patch(
        'mantidqtinterfaces.DNSReduction.file_selector.file_selector_'
        'presenter.'
